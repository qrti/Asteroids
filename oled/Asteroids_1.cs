...
public class Asteroids {
  ...
  public void initUfo() 
  {
    ...
    ufo.deltaX = MIN_ROCK_SPEED + rnd.NextDouble() * (MAX_ROCK_SPEED - MIN_ROCK_SPEED);
    ...
    ufo.deltaY = MIN_ROCK_SPEED + rnd.NextDouble() * (MAX_ROCK_SPEED - MIN_ROCK_SPEED);
